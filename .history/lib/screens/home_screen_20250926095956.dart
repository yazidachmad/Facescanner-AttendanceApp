          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildActionCard(context, Icons.login, "Check In", () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) =>
                ...
                _buildActionCard(context, Icons.logout, "Check Out", () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) =>
...
Widget _buildTodayAttendance() {
  return GridView.count(
    physics: NeverScrollableScrollPhysics(flase),
    shrinkWrap: true, // biar bisa dipakai di dalam Column / SingleChildScrollView
    crossAxisCount: 2, // 2 kolom
    crossAxisSpacing: 12,
    mainAxisSpacing: 12,
    childAspectRatio: 1.5, // atur biar proporsional
