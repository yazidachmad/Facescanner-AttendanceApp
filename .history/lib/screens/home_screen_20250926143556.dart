...
Widget _buildMenu(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Row(
                children: [
                  ...
                  if (_isReconnecting) const SizedBox(width:12),
                  if (_isReconnecting)
                    const SizedBox(
                      width: 12,
                      height: 12,
          ...
          _buildStatusItem("Camera", "Ready", Colors.green, Ionicons.camera),
          _buildStatusItem("ML Kit", "Ready", Colors.green, Icons.android),
        ],
      ),
    );
  }
  ...
  // 🔹 Status Item
  static Widget _buildStatusItem(String label, String status, Color color, IconData icon,) {
    return Padding(
