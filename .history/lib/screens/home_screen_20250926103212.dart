...
class _HomeScreenState extends State<HomeScreen> {
          ...
          children: [
            ...
            Row(
              children: [
                Text(
                  formattedDate,
                  style: TextStyle(fontSize: 16, color: context.tertiary),
                ),
                IconButton(
  ...
  return SizedBox(
    height: 120, // tinggi biar rapi
    child: ListView.separated(
      scrollDirection: Axis.horizontal, // 🔥 scroll ke kanan-kiri
      padding: const EdgeInsets.symmetric(horizontal: 12),
      itemCount: menus.length,
      separatorBuilder: (_, __) => const SizedBox(width: 12), // jarak antar card
      itemBuilder: (context, index) {
        final item = menus[index];
        return _buildActionCardHorizontal(
          context,
...
/// Update tampilan card biar lebih clean
Widget _buildActionCardHorizontal(
  ...
  return InkWell(
    ...
    child: Container(
      width: 100, // biar pas untuk scroll horizontal
      padding: const EdgeInsets.all(16),
    ...
    return Padding(
      ...
      child: Center(
        ...
        child: Wrap(
          ...
          runSpacing: 12, // jarak vertikal antar box
