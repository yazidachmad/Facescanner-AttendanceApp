                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                  Row(
                    children: [
                      Container(
    padding: const EdgeInsets.all(6), // jarak icon sama background
    decoration: BoxDecoration(
      color: Colors.blue.withOpacity(0.1), // warna background
