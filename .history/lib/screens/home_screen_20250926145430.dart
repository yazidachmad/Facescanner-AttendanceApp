...
Widget _buildMenu(BuildContext context) {
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      color: context.tertiary, // 🔥 full bar background
    ),
    child: Row(
  ...
  Widget _buildTodayAttendance() {
    return Padding(
      ...
      child: Center(
        ...
        child: Wrap(
          spacing: 10, // jarak horizontal antar box
          runSpacing: 10, // jarak vertikal antar box
  ...
  Widget _buildAttendanceBox({
    ...
    return SizedBox(
      width: 185, // fix biar keliatan grid 2x2
      child: Container(
        padding: const EdgeInsets.all(12),
        decoration: BoxDecoration(
          color: Colors.white,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            "System Status",
            style: TextStyle(fontSize: 20, color: Colors.white, fontFamily: 'Tommy'),
          ),
          const SizedBox(height: 16),
              ...
              Row(
                children: [
                  ...
                  (
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                    Icon(Ionicons.flame, color: Colors.red[600]),
          ...
          _buildStatusItem("Camera", "Ready", Colors.green, Ionicons.camera, Colors.black),
          _buildStatusItem("ML Kit", "Ready", Colors.green, Icons.android, Colors.green),
        ],
      ),
    );
  }
  ...
  // 🔹 Status Item
  static Widget _buildStatusItem(String label, String status, Color color, IconData icon, Color iconcolor) {
    return Padding(
