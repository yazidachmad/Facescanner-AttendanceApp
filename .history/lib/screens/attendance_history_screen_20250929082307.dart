...
class _AttendanceHistoryScreenState extends State<AttendanceHistoryScreen> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.symmetric(ver),
                      width: 110,
                      height: 100,
                      child: Image.asset('assets/images/hand.png', fit: BoxFit.cover),
                    )
            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text("Clock in Time", style: TextStyle(
                      fontSize: 16,
                ...
                Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Clock Out Time", style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w500
                      ),
                    ),
 ...
 Widget _buildAttendanceList(List<AttendanceRecord> records) {
  ...
  final showSeeAll = records.length > 5;
    ...
    children: [
      if (showSeeAll)
        Align(
          ...
          child: TextButton(
            onPressed: () => _showAllRecordsDialog(context, records),
            child: Row(
      ...
      Expanded(
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            AttendanceRecord record = topRecords[index];
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                DateFormat('dd MMM yyyy, HH:mm:ss').format(record.timestamp),
...
/// Dialog untuk semua records
void _showAllRecordsDialog(BuildContext context, List<AttendanceRecord> records) {
  showDialog(
    context: context,
    builder: (context) {
      return Dialog(
